  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,#fef2f2_0%,#fff5f5_44%,#ffffff_100%)] text-slate-900 flex flex-col items-center justify-center p-4">
      <div className="text-center max-w-md space-y-6">
        ...
        <p className="text-slate-600">{error.message || "Failed to load admin dashboard. Please try again."}</p>
        <Button onClick={reset} className="rounded-full bg-slate-950 text-white hover:bg-slate-800">
          Try again
        </Button>
      </div>
    </div>
